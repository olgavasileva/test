class Quantcast
  # https://measure.api.quantcast.com/api/v1/networks/{pCode}/domains/{domain}/demographics?country=US&api_key={API_Key}&sig={Signature}
  def initialize question_id, choice_id = nil
