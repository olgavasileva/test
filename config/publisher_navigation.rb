...
SimpleNavigation::Configuration.run do |navigation|
  ...
  navigation.items do |primary|
    ...
    primary.item :pro_listicals, '<i class="menu-icon fa fa-file-code-o"></i><span class="mm-text">Listicles</span>'.html_safe, listicals_path
    primary.item :pro_create_listicals, '<i class="menu-icon fa fa-plus-square"></i><span class="mm-text">Create Listicle</span>'.html_safe, new_listical_path(current_user)
