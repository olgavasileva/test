...
describe MultipleChoiceQuestion do
  describe :validations do
    it {except(FactoryGirl.build(:multiple_choice_question)).to be_valid}
    ...
    it {except(FactoryGirl.build(:multiple_choice_question, min_responses:1, max_responses:2)).to be_valid}
