...
describe :text_choice_question do
  ...
  before { post "v/2.0/questions/text_choice_question", Hash[params].to_json,{"CONTENT_TYPE" => "application/json"}}
  ...
  context "With all required params" do
    ...
    context "With a logged in user" do
      ...
      context "With valid field values" do
        ...
        let(:choice1) {{rotate:true, title:"Choice Title 1"}}
        let(:choice2) {{rotate:true, title:"Choice Title 2"}}
