...
describe 'GET questions/question' do
  ...
  describe "response with all question data" do
    it {expect(response_body.keys).to match_array %w(category choices comment_count creator_id creator_name description id response_count summary title type user_answered uuid image_url created_at member_community_ids)}
