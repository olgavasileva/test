...
describe :register_facebook do
  ...
  before { post "v/2.0/users/register/facebook/#{instance_token}", Hash[params].to_json,{"CONTENT_TYPE" => "application/json"}}
  ...
  context "With a valid instance" do
    ...
    context "With all required params" do
      let(:params) {{facebook_token:facebook_token, username:username}}
