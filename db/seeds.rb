...
q = TextQuestion.where(title:"What do you like about travelling?").first_or_create(category:places_and_travel,user:user, text_type:"freeform", min_characters:1, max_characters:200, image:open(seed_image("portfolio1.png")))
